 ...
 * description: 对ViewHolder的封装，以及更方便的控制ListView滑动过程中不加载图片
 *****************************************************/
public abstract class ZAdapter<T> extends BaseAdapter implements
    ...
    public ZAdapter(AbsListView view, Collection<T> mDatas, int itemLayoutId) {
        if (mDatas == null) {
