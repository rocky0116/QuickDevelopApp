...
public class RefreshView extends ViewGroup {
    ...
    private boolean isFullEnable = false;   //是否超过一屏时才允许上拉，
    // 为false则不满一屏也可以上拉，注意样式为isOverlap时，无论如何也不允许在不满一屏时上拉
...
//    private boolean _i1sOverlap;             //保存用户动态设置样式时传入的参数
    ...
    public RefreshView(Context context, AttributeSet attrs) {
        ...
        ta.recycle();
        //View view1 = inflater.inflate(R.layout.default_footer, this);
        //addView(view1);
        //requestLayout();
        //invalidate();
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //View view = inflater.inflate(R.layout.default_footer, this);
        //addView(view);
        //requestLayout();
        //invalidate();
    }
